      ...
      <div class="card card-primary">
        ...
        <form role="form" action="update.php" method="post">
          <div class="card-body">
            ...
            <div class="form-group">
              <label>โครงการย่อย/โครงการเดี่ยว</label>
              <select class="form-control" required name="sb_sg">
                <option value="" disabled selected>เลือก โครงการย่อย/โครงการเดี่ยว</option>
                <option value="โครงการย่อย"<?php echo $row['sb_sg'] == 'โครงการย่อย'? 'selected': '' ?>>โครงการย่อย</option>
            ...
            <div class="form-group">
              ...
              <select class="form-control" required name="st1">
                ...
                <option value="คืนทุน"<?php echo $row['st1'] == 'คืนทุน'? 'selected': '' ?>>คืนทุน</option>
              </select>
            </div>        
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="rt2">
                <option value="" disabled selected>เลือก ประเภทนักวิจัย</option>
                <option value="ยังไม่มีการเลือก"<?php echo $row['rt2'] == 'ยังไม่มีการเลือก'? 'selected': '' ?>>ยังไม่มีการเลือก</option>
            ...
            <div class="form-group">
              ...
              <select class="form-control"  name="ra2">
                ...
                <option value="ยังไม่มีการเลือก"<?php echo $row['ra2'] == 'ยังไม่มีการเลือก'? 'selected': '' ?>>ยังไม่มีการเลือก</option>
            ...
            <div class="form-group">
              ...
              <select class="form-control"  name="st2">
                <option value="" disabled selected>เลือก สถานะ</option>
                <option value="ยังไม่มีการเลือก"<?php echo $row['st2'] == 'ยังไม่มีการเลือก'? 'selected': '' ?>>ยังไม่มีการเลือก</option>
                ...
                <option value="คืนทุน"<?php echo $row['st2'] == 'คืนทุน'? 'selected': '' ?>>คืนทุน</option>
              </select>
            </div> 
            ...
            <div class="form-group">
              ...
              <select class="form-control"  name="st3">
                ...
                <option value="คืนทุน"<?php echo $row['st3'] == 'คืนทุน'? 'selected': '' ?>>คืนทุน</option>
              </select>
            </div> 
            ...
            <div class="form-group">
              ...
              <select class="form-control"  name="st4">
                ...
                <option value="คืนทุน"<?php echo $row['st4'] == 'คืนทุน'? 'selected': '' ?>>คืนทุน</option>
              </select>
            </div> 
            ...
            <div class="form-group">
              ...
              <select class="form-control"  name="st5">
                ...
                <option value="คืนทุน"<?php echo $row['st5'] == 'คืนทุน'? 'selected': '' ?>>คืนทุน</option>
              </select>
            </div> 
