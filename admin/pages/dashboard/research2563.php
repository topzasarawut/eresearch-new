...
<div class="wrapper">
  ...
  <?php
        ...
        $sql = "SELECT COUNT(*) AS aa  FROM project_eresearch WHERE year='2563' "; 
        ...
        // จำนวนงบประมาณ
        //งบจัดสรรที่ 1
        $sql = "SELECT SUM(ab1) AS topza FROM project_eresearch WHERE year='2563'";
        $result = $conn->query($sql);
        $row = $result->fetch_assoc();
        $sumab1= $row["topza"];
        //งบจัดสรรที่ 2
        $sql = "SELECT SUM(ab2) AS topza FROM project_eresearch WHERE year='2563'";
        $result = $conn->query($sql);
        $row = $result->fetch_assoc();
        $sumab2= $row["topza"];
        //งบจัดสรรที่ 3
        $sql = "SELECT SUM(ab3) AS topza FROM project_eresearch WHERE year='2563'";
        $result = $conn->query($sql);
        $row = $result->fetch_assoc();
        $sumab3= $row["topza"];
        //งบจัดสรรที่ 4
        $sql = "SELECT SUM(ab4) AS topza FROM project_eresearch WHERE year='2563'";
        $result = $conn->query($sql);
        $row = $result->fetch_assoc();
        $sumab4= $row["topza"];
        //งบจัดสรรที่ 5
        $sql = "SELECT SUM(ab5) AS topza FROM project_eresearch WHERE year='2563'";
        $result = $conn->query($sql);
        $row = $result->fetch_assoc();
        $sumab5= $row["topza"];
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ปี2563</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">ปี2563</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php
           $sql = "SELECT * FROM `project_eresearch`WHERE `year`=2563";
           $result = $conn->query($sql);
          //  echo $result;
        ?>
       <!-- Default box -->
      <div class="card">
        <div class="card-header">
          <h3 class="card-title d-inline-block">research2563 List</h3>
