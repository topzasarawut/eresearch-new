    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php } ?>
          <li class="nav-item">
            <a href="../project" class="nav-link <?php echo $name == 'project' ? 'active': '' ?>">
            <i class="fas fa-id-card"></i>
              <p>ชุดโครงการ/โครงการเดี่ยว</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="../findresearch" class="nav-link <?php echo $name == 'findresearch' ? 'active': '' ?>">
              <i class="fas fa-chalkboard-teacher nav-icon"></i>
              <p>เพิ่มงานวิจัยที่เผยแพร่</p>
            </a>
          </li>
          <!-- <li class="nav-item">
