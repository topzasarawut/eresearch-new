<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
        <div class="container">
            <a href="index.php"><img class="logo" src="img/cpruSmall.png" height="50" alt="Logo"></a>
            <a class="navbar-brand" href="index.php">Findresearch Eresearch สถาบันวิจัยและพัฒนา มหาวิทยาลัยราชภัฏชัยภูมิ</a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <ul class="navbar-nav mr-auto">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="rent.php">รายละเอียดการเช่ารถ<span class="sr-only">(current)</span></a>
                 </li>
                 <li class="nav-item">
              ...
              <ul class="navbar-nav mr-auto">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <!-- <a class="btn btn-warning" href="register.php">ลงทะเบียนแข่งขันตอบปัญหาทางวิชาการ</a> -->
                    </li>
                    <?php } ?>
               </ul>
            </div>
